...
public class ToDoProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "uark.csce4623.rblowry.todolist.todoprovider";
    ...
    public static final String TODO_TABLE_COL_DUE_DATE = "DUEDATE";
    public static final String TODO_TABLE_COL_IS_FINISHED = "ISFINISHED";
    ...
    private static final String SQL_CREATE_MAIN = "CREATE TABLE " +
            ...
            TODO_TABLE_COL_IS_FINISHED + " TEXT)";
